...
https://github.com/flserv/Control_y_robotica/blob/4bba3ee8cce3beabdede538aaa79e755fed0eb92/images/sistemadecontrolabierto%20(1).jpg[Sistema de lazo abierto,width=70%, align=center]


Cuando la salida influye en las señal de entrada, se dice que es de *lazo cerrado* o con *realimentación*. 

image::https://raw.githubusercontent.com/flserv/Control_y_robotica/4bba3ee8cce3beabdede538aaa79e755fed0eb92/images/sistemadecontrolabierto%20(1).jpg[Sistema de lazo cerrado,width=70%, align=center]
